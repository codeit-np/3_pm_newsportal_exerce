...
<head>
    ...
    <link rel="stylesheet" href="/modular/css/vendor.css">
    <!-- Theme initialization -->
    <link rel="stylesheet" href="/modular/css/app.css">
    ...
    {{-- <script>
            ...
            if (themeName)
            {
                document.write('<link rel="stylesheet" href="/modular/css/app-' + themeName + '.css">');
            }
            else
            {
                document.write('<link rel="stylesheet"  href="/modular/css/app.css">');
            }
        </script> --}}
...
<body>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body modal-tab-container">
                            <ul class="nav nav-tabs modal-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#upload" data-toggle="tab"
                                        role="tab">Upload</a>
                                </li>
                            </ul>
    ...
    <script src="/modular/js/vendor.js"></script>
    <script src="/modular/js/app.js"></script>
