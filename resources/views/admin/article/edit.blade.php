            ...
            <div class="card-body">
                ...
                @method('put')
                    <div class="form-group">
                        ...
                        <input id="title" class="form-control" type="text" name="title" placeholder="eg.Title" value="{{ $article->title }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  class="form-control summernote" name="description">{{ $article->description}}</textarea>
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="metaword" class="form-control" name="metaword" rows="3">{{ $article->meta_word }}</textarea>
                     </div>

                     <div class="form-group">
                        <label for="metadescription">Meta Description (Optional)</label>
                        <textarea id="metadescription" class="form-control" name="metadescription" rows="3">{{ $article->meta_description }}</textarea>
                     </div>
